...
//            connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            preparedStatement = configuracionJDBC.conectarConBaseDeDatos().prepareStatement("INSERT INTO pacientes(nombre,apellido,dni,fecha_ingreso,domicilio_id) VALUES(?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
...
//            connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            preparedStatement = configuracionJDBC.conectarConBaseDeDatos().prepareStatement("DELETE FROM pacientes where id = ?");
...
//            connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            //4 Obtener resultados
            while (result.next()) {
                Paciente paciente = crearPaciente(result);
...
//            connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
    ...
    private Paciente crearPaciente(ResultSet result) throws SQLException {

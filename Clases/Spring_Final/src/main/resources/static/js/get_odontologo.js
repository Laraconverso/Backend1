      ...
      .then(data => {
         ...
         for(odontologo of data){
            ...
            odontologoRow.id = tr_id;
             ...
             let deleteButton = '<button' + ' id=' + '\"' + 'btn_delete_' + tr_id + '\"' + ' type="button" onclick="deleteBy('+tr_id+')"' + 'class="btn btn-danger btn_delete">' + '&times' + '</button>';

             let updateButton = '<button' +' id=' + '\"' + 'btn_id_' + tr_id + '\"' + ' type="button" onclick="findBy('+odontologo.id+')"' + ' class="btn btn-info btn_id">' + tr_id + '</button>';
